...
public class BookTrain extends JFrame implements ActionListener {
    ...
    JButton checkprice, bookpackage, back,viewbookedtrain;
    JDateChooser dateChooser;
    
    
    BookTrain(String username) {
        ...
        JLabel text = new JLabel("BOOK TRAVEL");
        text.setBounds(140, 10, 200, 30);
        text.setFont(new Font("Tahoma", Font.BOLD, 20));
        add(text);
        
        JLabel lbltravel = new JLabel("Travel Method");
        lbltravel.setBounds(40, 230, 150, 20);
        lbltravel.setFont(new Font("Tahoma", Font.BOLD, 16));
        add(lbltravel);
        ...
        ctravel.add("TRAIN");
        ctravel.add("FLIGHT");
        ctravel.setBounds(250, 230, 200, 20);
        add(ctravel);
        
        JLabel lbldate = new JLabel("Traveling Date");
        ...
        lblpersons.setBounds(40, 270, 150, 20);
        ...
        viewbookedtrain = new JButton("View Booked Travel");
        viewbookedtrain.setBounds(570, 30, 200, 25);
        viewbookedtrain.setBackground(new Color(0, 0, 139));
        viewbookedtrain.setForeground(Color.white);
        viewbookedtrain.addActionListener(this);
        add(viewbookedtrain);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/booktravel.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == checkprice) {
            String pack = ctravel.getSelectedItem();
            int cost = 0;
            if (pack.equals("BUS")) {
                cost += 500;
            } else if (pack.equals("TRAIN")) {
                cost += 1500;
            } else {
                cost += 7000;
            }
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("INSERT INTO travel(username, depfrom, rchwhere, persons, id, number, phone, price, booking_date, travel_medium) VALUES ('" + labelusername.getText() + "', '" + tffrom.getText() + "', '" + tfwhere.getText() + "', '" + tfpersons.getText() + "', '" + labelid.getText() + "', '" + labelnumber.getText() + "', '" + labelphone.getText() + "', '" + labelprice.getText() + "', CURDATE(), '" + ctravel.getSelectedItem() + "')");
            ...
            setVisible(false);
        }else if(ae.getSource() == viewbookedtrain){
        
            new viewBookedTrain(username); 
        }  
    }
    
    public static void main(String[] args) {
        new BookTrain("Sourabh01");
    }
}
